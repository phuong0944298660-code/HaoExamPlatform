    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/v1/accounts/refresh").permitAll() // 允许刷新
                .requestMatchers("/api/v1/accounts/logout").permitAll()  // 允许登出
                .requestMatchers("/api/v1/accounts/activate").permitAll()
                .requestMatchers("/swagger-ui/**", "/v3/api-docs/**", "/swagger-ui.html").permitAll()
                .requestMatchers("/actuator/**").permitAll()
                .requestMatchers(HttpMethod.OPTIONS, "/**").permitAll()
                .requestMatchers("/api/v1/system/menus/nav").permitAll()
